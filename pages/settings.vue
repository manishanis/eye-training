...
<template>
  <div class="settings-page p-6 max-w-md mx-auto bg-gray-800 text-gray-200 rounded-lg shadow-lg">
    <h1 class="text-2xl font-bold mb-6 text-center">Game Settings</h1>

    <div class="mb-4">
      <label for="totalRounds" class="block text-sm font-medium mb-1">Total Rounds:</label>
      <input
        id="totalRounds"
      ...
      />
      <p class="text-xs text-gray-400 mt-1">Number of rounds before the game ends.</p>
    </div>
